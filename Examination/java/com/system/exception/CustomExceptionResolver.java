...
//        httpServletResponse.setCharacterEncoding("utf-8");
        ...
        if (e instanceof CustomException) {
            ...
            //用户名错误异常
            modelAndView.addObject("message", "Username does not exist");
            ...
            modelAndView.addObject("message", "Your operation is wrong, please see the compiler exception information");
