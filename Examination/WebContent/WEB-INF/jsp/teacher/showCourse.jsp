			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 class="col-md-5">Courses I teach</h1>
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/teacher/selectCourse" id="form1" method="post">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Please enter the course name" name="findByName">
				    ...
				    <table class="table table-bordered">
					        <thead>
					            <tr>
									...
									<th>CourseName</th>
									<th>TeacherID</th>
									<th>CourseMeetingTime</th>
									<th>CourseMeetingPlace</th>
									<th>Week</th>
									<th>CourseType</th>
									<th>CourseCredit</th>
									<th>Operation</th>
