		...
		<div class="col-md-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<h1 class="col-md-5">Student list management</h1>
				...
				<table class="table table-bordered">
					...
					<c:forEach  items="${studentList}" var="item">
						<tr>
							...
							<td>
								<button class="btn btn-default btn-xs btn-info" onClick="location.href='/admin/editStudent?id=${item.userid}'">Modify</button>
								<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/admin/removeStudent?id=${item.userid}'">Delete</button>
								<!--Popup-->
							</td>
						</tr>
					</c:forEach>
				...
				<div class="panel-footer">
					<c:if test="${pagingVO != null}">
						<nav style="text-align: center">
							<ul class="pagination">
								<li><a href="/admin/showStudent?page=${pagingVO.upPageNo}">&laquo;Previous Page</a></li>
								...
								<li><a href="/admin/showStudent?page=${pagingVO.totalCount}">Last Page&raquo;</a></li>
							</ul>
						</nav>
					</c:if>
				</div>
