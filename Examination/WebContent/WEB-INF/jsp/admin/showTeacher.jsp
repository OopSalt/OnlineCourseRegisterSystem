		...
		<div class="col-md-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<h1 class="col-md-5">Teacher list management</h1>
						<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/admin/selectTeacher" id="form1" method="post">
							<div class="input-group">
								<input type="text" class="form-control" placeholder="Please enter a name" name="findByName">
				...
				<table class="table table-bordered">
					...
					<c:forEach  items="${teacherList}" var="item">
						<tr>
							...
							<td>
								<button class="btn btn-default btn-xs btn-info" onClick="location.href='/admin/editTeacher?id=${item.userid}'">Modify</button>
								<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/admin/removeTeacher?id=${item.userid}'">Delete</button>
								<!--Popup-->
							</td>
						</tr>
					</c:forEach>
				...
				<div class="panel-footer">
					<c:if test="${pagingVO != null}">
						<nav style="text-align: center">
							<ul class="pagination">
								<li><a href="/admin/showTeacher?page=${pagingVO.upPageNo}">&laquo;Previous Page</a></li>
								...
								<li><a href="/admin/showTeacher?page=${pagingVO.totalCount}">Last Page&raquo;</a></li>
							</ul>
						</nav>
					</c:if>
				</div>
