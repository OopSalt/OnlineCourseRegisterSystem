<%-- Created by IntelliJ IDEA. User: Jacey Date: 2017/6/30 Time: 9:30 To change
this template use File | Settings | File Templates. --%> <%@ page
        contentType="text/html;charset=UTF-8" language="java" %> <%--shiro标签--%>
        ...
        <div class="col-md-12">
            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="navbar-header">
                    <a href="##" class="navbar-brand">Student register system</a>
                </div>
